...
urlpatterns = [
    ...
    path('update_admin_profile', AdminViews.update_admin_profile,
    ...
    path('delete_staff/<str:staff_id>',
         AdminViews.delete_staff, name="delete_staff"),
    ...
    path('edit_student/<str:student_id>',
         AdminViews.edit_student, name="edit_student"),
    path('update_student', AdminViews.update_student, name="update_student"),
    path('delete_student/<str:student_id>',
         AdminViews.delete_student, name="delete_student"),
    path('feedback_messages', AdminViews.feedback_messages,
    ...
    path('manage_registration', AdminViews.manage_registration,
         name="manage_registration"),
    path('reg_approve/<str:student_id>',
         AdminViews.reg_approve, name="reg_approve"),
    ...
    path('reset_final_grade', AdminViews.reset_final_grade,
         name="reset_final_grade"),

    # Staff Path
    path('staff_home', StaffViews.staff_home, name="staff_home"),
    path('staff_profile', StaffViews.staff_profile, name="staff_profile"),
    path('update_staff_profile', StaffViews.update_staff_profile,
    ...
    path('update_company_profile', CompanyViews.update_company_profile,
    ...
    path('update_student_profile', StudentViews.update_student_profile,
         name="update_student_profile"),
    path('student_feedback', StudentViews.student_feedback, name="student_feedback"),
    path('save_feedback', StudentViews.save_feedback, name="save_feedback"),
    path('student_registration', StudentViews.student_registration,
         name="student_registration"),
    path('confirm_registration', StudentViews.confirm_registration,
         name="confirm_registration"),
    path('cancel_registration', StudentViews.cancel_registration,
